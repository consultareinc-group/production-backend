...
use App\Http\Controllers\ProductionManagementSystem\ProductionPlanning\RouteController as ProductionPlanningRouteController;
...
class SystemRouteController extends Controller
{
    public static function registerRoutes()
    {
        ...
        Route::prefix('production-management')->middleware(['sanitize-request','jwt', 'user-permission'])->group(function () {
            ...
            ProductionPlanningRouteController::moduleRoute();
